...
// Get request on '/api/teacher/course-status-report'
func TeacherCourseStatusReport(c *gin.Context) {
	// Checking if logged in
	if !teacherHelpers.CheckLogin(c) {
		c.JSON(401, "Not Logged in teacher")
		return
...
// Get request on '/api/teacher/course-gender-report'
func TeacherCourseGenderReport(c *gin.Context) {
	// Checking if logged in
	if !teacherHelpers.CheckLogin(c) {
		c.JSON(401, "Not Logged in teacher")
		return
...
// Get request on '/api/teacher/course-category-report'
func TeacherCourseCategoryReport(c *gin.Context) {
	// Checking if logged in
	if !teacherHelpers.CheckLogin(c) {
		c.JSON(401, "Not Logged in teacher")
		return
